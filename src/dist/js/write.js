...
function _makeArticle() {
  _makeArticle = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var title, contents, password, config, data, res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            contents = document.querySelector(".contents_textarea").value;
            password = document.querySelector(".password_input").value;
            config = {};
            data = new FormData();
            data.append("title", title);
            data.append("contents", contents);
            data.append("password", password); // data.append("views", 0);
            // data.append("recommended", 0);

            _context.next = 11;
            return axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(_api__WEBPACK_IMPORTED_MODULE_1__["URL_POST_MAKE_ARTICLE"], data, config);
...
/***/ 1:
/*!***********************************************!*\
  !*** multi @babel/polyfill ./src/js/write.js ***!
  \***********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"./node_modules/@babel/polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./src/js/write.js */"./src/js/write.js");
