...
function _getArticleList() {
  _getArticleList = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var config, res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            config = {};
            _context.next = 4;
            return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get(_api__WEBPACK_IMPORTED_MODULE_0__["URL_GET_ARTICLE_LIST"], config);
            ...
            articleList.map(function (article) {
              ...
              for (var i = 0; i < itemArr.length; i++) {
                if (itemArr[i] === "title") {
                  ...
                  _new_td.innerHTML = article[itemArr[i]];
                  new_tr.appendChild(_new_td);
                }
              }
